...
public class MasterTriggerSend implements HBAction {
    ...
    public void action(HB hb) {
         ...
         *************************************************************/
        IntegerBuddyControl clockRate = new IntegerBuddyControl(this, "Clock Rate", CLOCK_INTERVAL, 10, 1000) {
         ...
         *************************************************************/
        BooleanControl runClock = new BooleanControl(this, "Start / Stop", !clock.isPaused()) {
            @Override
